...
public class HW4_Part2 {
	...
	static final String laptop_path = "C:\\Users\\acer\\OneDrive\\Desktop\\Test\\";
	...
	public static void main(String[] args) throws Exception {
		...
		for (char c : arr) {
			...
			csvToDB.csvToDb(courses, getLaptopPath(c));
		}
		...
		List<ISchedule> lst = courseera.roomSchedule(new Room("BLISS", "205"), DayOfWeek.Friday);
		//System.out.println(lst);
		for (var a : lst) System.out.println(a);
		//System.out.println(lst.size());
		//ISchedule s = courseera.whoWasThereLast(new Room("BLISS", "205"));
		//System.out.println(s);
		lst = courseera.profSchedule(new Instructor("Mahmoud", "Bdeir"));
		for (var a : lst) System.out.println(a);
		ISchedule s = courseera.whereIsProf(new Instructor("Mahmoud", "Bdeir"));
		System.out.println(s);
	...
	public static String getLaptopPath(char c) {
		return laptop_path + c + ".csv";
	}
